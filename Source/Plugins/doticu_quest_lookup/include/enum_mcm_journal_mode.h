...
namespace doticu_skylib { namespace doticu_quest_lookup {
    ...
    public:
        ...
        static inline some<const char* const*> Strings()
        {
            ...
            {
                SKYLIB_ENUM_TO_STRING(LOOKUP),
                SKYLIB_ENUM_TO_STRING(HIDE),
            };
    ...
    class MCM_Journal_Mode_e :
        public Enum_Type_t<MCM_Journal_Mode_e_data>
    {
    public:
...
namespace doticu_skylib {
    ...
    template <>
    class none<doticu_quest_lookup::MCM_Journal_Mode_e> :
        public none_enum<doticu_quest_lookup::MCM_Journal_Mode_e>
    {
    public:
    ...
    template <>
    class maybe<doticu_quest_lookup::MCM_Journal_Mode_e> :
        public maybe_enum<doticu_quest_lookup::MCM_Journal_Mode_e>
    {
    public:
    ...
    template <>
    class some<doticu_quest_lookup::MCM_Journal_Mode_e> :
        public some_enum<doticu_quest_lookup::MCM_Journal_Mode_e>
    {
    public:
